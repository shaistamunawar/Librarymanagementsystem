...
public class Issue extends javax.swing.JFrame {
    ...
    String header[]=new String[]{"Book Id","Book Name","publisher","auhtor"};
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(edition, javax.swing.GroupLayout.DEFAULT_SIZE, 102, Short.MAX_VALUE)
    ...
    try{
        ...
        try{
            ...
            try(BufferedWriter bw=new BufferedWriter(fw)){
                ...
                bw.write(new String(Author.getBytes())+":");
                bw.write("\r\n");
            }
      ...
      //  DefaultTableModel d1=(DefaultTableModel)issuetable.getModel();
        try{
            ...
            DefaultTableModel d1=(DefaultTableModel)issuetable.getModel();
            Object[] tablelines=b1.lines().toArray();
            for(int i=0;i<tablelines.length;i++){
                String line=tablelines[i].toString().trim();
                String[] dataRow=line.split(":");
                d1.addRow(dataRow);
            }
           // d1.addRow(new Object[]{bookid.getText(),bookname.getText(),publisher.getText(),edition.getText()});
